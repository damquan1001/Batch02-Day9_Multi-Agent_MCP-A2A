...
QUESTION = (
    "A tech startup breached a customer contract, shared user data without consent, "
...
SYSTEM_PROMPT = (
    ...
    "case law, data privacy, tax, and compliance. Keep your final answer under 500 words."
)
...
async def main():
    ...
    llm = get_llm()
    graph = create_react_agent(model=llm, tools=TOOLS, prompt=SYSTEM_PROMPT, debug=True, verbose=True)
